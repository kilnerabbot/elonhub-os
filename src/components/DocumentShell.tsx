  ...
  return (
    <div className="min-h-screen bg-bg py-6 print:bg-white print:py-0">
      ...
      <article className="document mx-auto w-[210mm] max-w-[95vw] bg-white p-5 text-[#171715] shadow-sm sm:p-[16mm] print:w-auto print:max-w-none print:p-0 print:shadow-none">
        <header className="flex flex-col items-start gap-4 border-b border-[#e2ded4] pb-6 sm:flex-row sm:justify-between sm:gap-8 print:flex-row print:justify-between">
          <div>
        ...
        <section className="mt-6 flex flex-col gap-4 sm:flex-row sm:justify-between sm:gap-8 print:flex-row print:justify-between">
          <div>
